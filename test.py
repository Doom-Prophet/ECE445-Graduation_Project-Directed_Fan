...
testlist = ["lss","up","down","on","haha","off"]
...
for i in testlist: #send 5 groups of data to the bluetooth
	print("Ping")
	bluetooth.write(str.encode(i))#These need to be bytes not unicode, plus a number
